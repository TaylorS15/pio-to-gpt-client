  ...
  return (
    <main className="relative flex min-h-screen flex-col gap-8 bg-black px-6 pt-24 text-white md:px-0">
      ...
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-4">
        ...
        <ul>
          ...
          <li className="ml-4">
            <p>
              ...
              in this Agreement) refers to GTOtoGPT.
            </p>
          </li>
          <li className="ml-4">
            <p>
          ...
          <li className="ml-4">
            <p>
              <strong>Website</strong> refers to GTOtoGPT, accessible from{" "}
              <Link
                href="https://gtotogpt.com"
        ...
        <ul>
          <li className="ml-4">By email: support@gtotogpt.com</li>
        </ul>
      </div>
